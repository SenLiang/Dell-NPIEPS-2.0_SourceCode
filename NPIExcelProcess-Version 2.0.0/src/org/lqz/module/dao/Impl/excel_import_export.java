...
//            System.out.println("stColumn-------------"+stColumn);
            ...
            if (readFileName == "AgileBom") {
                for (int i = 0; i < stRows; i++) {
                    ...
                    Cell Quantitycell = sheet.getRow(i).getCell(23);
                    ...
                    //System.out.println("Levelcell-" +getCellValue(Levelcell)+" Numbercell-" +getCellValue(Numbercell)
                         //   +" Descriptioncell-" +getCellValue(Descriptioncell)+" Quantity-" +getCellValue(Quantitycell));
...
//        new BaseDaoImpl();
//        String filePath = "C:/Users/sen_liang/Desktop/Code-history/NPIExcelProcess-8-21/src/TestCase/1-Agile_BOM.xls";
//        File excelFile = new File(filePath);
//        ArrayList<ArrayList<String>> readExcel = null;
//        try {
//            readExcel = ReadDataFromExcel(filePath, "AgileBom");
        ...
        try {
            ...
            if (readFileName == "AgileBom") {
                ...
                stm.executeUpdate("create table Agile_BOM(" +
                        ...
                        "Level vachar(10), Number vachar(30), Description vachar(50),Qty vachar(10));"); //+  //9,10,11,12
