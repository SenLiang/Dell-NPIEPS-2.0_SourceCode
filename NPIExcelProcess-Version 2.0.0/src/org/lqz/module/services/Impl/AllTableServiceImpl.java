...
public class AllTableServiceImpl {
    ...
    public Vector<Vector> AgileBomSelectByCondition() throws Exception {
        ...
        StringBuilder sqlBuilder = new StringBuilder(
                "select id, Level,Number, Description,Qty from Agile_BOM ");
    ...
    public static void AgileEMCTable() {
        ...
        try {
            ...
            stm.executeUpdate("create table Agile_EMC as " +
                    "select  DISTINCT  Agile_BOM.id as id, Agile_BOM.Level as Level, Number, Description, Material_Number_Desc, New_Version, Qty \n" +
    ...
    public int AgileBomupdateById(Object[] paraArray) throws Exception {
        int result = 0;
        result = update("update Agile_BOM set  Level=?,Number=?,Description=?,Qty=? where id=?",
                paraArray);
        return result;
    }
