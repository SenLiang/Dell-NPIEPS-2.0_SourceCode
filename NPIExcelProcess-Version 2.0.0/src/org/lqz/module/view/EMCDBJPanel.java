...
//		tool_modify.setText("修改商品");
        ...
        Icon icon_go = new ImageIcon(IndexJFrame.class.getResource("/image/search.png"));
        JPanel input = new JPanel(new FlowLayout(FlowLayout.CENTER));
        QButton = new JButton(icon_go);
        QButton.setPreferredSize(new Dimension(80, 40));
        QButton.setBorderPainted(false);
        QButton.setToolTipText("搜索PathNumber");
