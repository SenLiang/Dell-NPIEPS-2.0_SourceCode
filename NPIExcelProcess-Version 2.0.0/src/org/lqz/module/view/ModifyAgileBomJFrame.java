...
public class ModifyAgileBomJFrame extends JFrame implements MouseListener {
    ...
    JLabel  label_Level, label_Number,  label_Description,  label_Quantity;
    JTextField  id,Level, Number,Description,Quantity;
    ...
    public void initContentPanel() {
        ...
        label_Quantity = new JLabel("Quantity", JLabel.CENTER);
       // id = new JTextField(String.valueOf(table.getValueAt(selectedRow, 0)));
        ...
        Quantity = new JTextField((String) table.getValueAt(selectedRow, 4));
        ...
        contentPanel.add(label_Quantity);
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == button_modify) {
            ...
            String Quantity_String = Quantity.getText().trim();
...
//            } else
            ...
            } else if (Quantity_String.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "请输入Quantity");
                } else {
                int result = 0;
                //int id_int = Integer.valueOf(id_String);
                String selecteid = String.valueOf(table.getValueAt(selectedRow, 0)) ;

                Object[] params = {  Level_String, Number_String, Description_String,Quantity_String,selecteid};
